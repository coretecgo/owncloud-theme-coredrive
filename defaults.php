...
class OC_Theme {
	...
	public function getSlogan() {
		return 'Sua cloud, personalizada para você!';
	}
	...
	public function getLogoClaim() {
		return '<a href="//coretecnologia.net.br">CoreTecnologia</a>';
	}
